...
public class PairOfStrings implements WritableComparable<PairOfStrings> {
	...
	/**
	 * Defines a natural sort order for pairs. Pairs are sorted first by the left
	 * element, and then by the right element.
	 *
	 * @return a value less than zero, a value greater than zero, or zero if this
	 *         pair should be sorted before, sorted after, or is equal to
	 *         <code>obj</code>.
	 */
